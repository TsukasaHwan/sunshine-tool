...
public class BankCardUtils {
     ...
     * BIN号
     */
    private final static String[] BANK_BIN = {
    ...
    public static boolean checkBankCard(String cardId) {
        ...
        int cardLenth = substring.trim().length();
        if (cardLenth == 0 || !substring.matches("\\d+")) {
            return false;
        }
        char bit = getBankCardCheckCode(substring);
    ...
    public static String getNameOfBank(String idCard) {
        ...
        //8位Bin号
        String cardBin8 = idCard.substring(0, 8);
        for (int i = 0; i < BANK_BIN.length; i++) {
            if (cardBin8.equals(BANK_BIN[i])) {
                index = i;
            }
        }
        if (index != -1) {
