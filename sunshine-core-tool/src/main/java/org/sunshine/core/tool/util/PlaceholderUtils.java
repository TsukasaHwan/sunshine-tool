...
public class PlaceholderUtils {
     ...
     * 默认单例解析器
     */
    private static final PlaceholderUtils DEFAULT_RESOLVER = new PlaceholderUtils();
    ...
    private PlaceholderUtils(String placeholderPrefix, String placeholderSuffix) {
     ...
     */
    public static PlaceholderUtils getDefaultResolver() {
        return DEFAULT_RESOLVER;
    }

    public static PlaceholderUtils getResolver(String placeholderPrefix, String placeholderSuffix) {
        return new PlaceholderUtils(placeholderPrefix, placeholderSuffix);
    }
