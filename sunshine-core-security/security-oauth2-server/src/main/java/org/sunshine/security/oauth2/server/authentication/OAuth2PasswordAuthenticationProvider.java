package org.sunshine.security.oauth2.server.authentication;
...
public class OAuth2PasswordAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        Authentication usernamePasswordAuthentication = getUsernamePasswordAuthentication(passwordAuthenticationToken);
    ...
    private Authentication getUsernamePasswordAuthentication(OAuth2PasswordAuthenticationToken passwordAuthenticationToken) {
